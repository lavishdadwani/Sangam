...
{  showSearch ? <RxCross2 size={25} className="text-[#ff4d2d] md:hidden" onClick={() => setShowSearch(prev => !prev)} /> : <IoIosSearch size={25} className="text-[#ff4d2d] md:hidden" onClick={() => setShowSearch(prev => !prev)} />}        <div className="relative cursor-pointer">
